...
export function Hero() {
  return (
    <section className="pt-28 md:pb-16 px-4 sm:px-6 lg:px-8 sm:pb-6 relative overflow-hidden">
      {/* Soft background */}
      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          <div className="max-w-2xl">
            ...
            {/* CTAs */}
            <div className="mt-7 flex flex-row sm:flex-row items-center gap-4">
              ...
              <BookingModal>
                <Button size="lg" className="rounded-full px-6 py-5 text-white bg-teal-900 hover:bg-teal-950">
                Book Call
                </Button>
              </BookingModal>
            </div>
            ...
            {/* Trust bar */}
              <div className="mt-10">
              <div className="text-xs text-muted-foreground mb-3">Trusted by the d2c brands</div>
              <div className="grid grid-cols-2 sm:grid-cols-3 md:flex md:flex-nowrap items-center justify-between gap-4 md:gap-6 opacity-90">

                <img
                  src="https://ik.imagekit.io/90xvn3fidvl/logos/joy-organics_Q2xjFjfo7.avif"
                  alt="Joy Organics"
                  className="h-4 sm:h-4 object-contain"
                />
                <img
                  src="https://ik.imagekit.io/90xvn3fidvl/logos/everden_HZm259zEP.svg"
                  alt="Everden"
                  className="h-4 sm:h-4 object-contain"
                />
                <img
                  src="https://ik.imagekit.io/90xvn3fidvl/logos/vyrao_GRalYtgXh.avif"
                  alt="Vyrao"
                  className="h-4 sm:h-4 object-contain"
                />
                <img
                  src="https://ik.imagekit.io/90xvn3fidvl/logos/sijo_0d-UnU5yo.avif"
                  alt="Sijo"
                  className="h-4 sm:h-4 object-contain"
                />
              </div>
          ...
          <div className="relative overflow-hidden p-2 sm:p-4 md:p-8 w-full max-w-full">
            <div className="grid grid-cols-2 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-x-10 md:gap-y-10 place-items-center max-w-full">
              {/* Product Card */}
              <img
                src="https://ik.imagekit.io/90xvn3fidvl/smartwatch?updatedAt=1760523585616"
                alt="Product card with price and add-to-cart"
                className="w-full max-w-xs sm:max-w-xs md:max-w-md lg:max-w-lg rounded-xl shadow-lg ring-1 ring-black/5 object-cover transform rotate-[-2deg] sm:translate-y-2 transition-all duration-300 hover:rotate-0 hover:-translate-y-2 hover:shadow-xl"
              />
